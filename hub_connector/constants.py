class Errors:
    ...
    base_url_not_provided = "The 'base_url' was not provided. Preventing announcement query to 3D Hub"
    openid_config_unset = "Error connecting to 3D Hub. 'oidc_client_id' or 'oidc_client_secret' not set"
...
class Config:
    ...
    default_hub_host = "http://127.0.0.1"
    default_hub_port = 4000
